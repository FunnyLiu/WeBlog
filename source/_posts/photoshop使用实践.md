...
# **修改图像中某一中色值的颜色**
有时候我们只有一张图像,而没有psd原稿,所以拿不到每个图标的图层,不能用上面改变图层颜色的方法来改变图标的颜色.
例如,我们想把下图中左边的三个图标变成白色.
![img](/photoshop使用实践/24.png)

首先选中区域,然后点击菜单栏中的**图像**,**调整**,**替换颜色**. 

![img](/photoshop使用实践/25.png)

首先通过上部的吸管选中想要改变的色值,然后将右下角的结果设置为想要的颜色,即可.

![img](/photoshop使用实践/26.png)

最后得到白色图标:

![img](/photoshop使用实践/27.png)
