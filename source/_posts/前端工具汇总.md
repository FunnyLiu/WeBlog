...
# **命令行**
[blessed](https://github.com/chjj/blessed) 命令行交互工具,pm2的monitor就是基于此开发,命令行看起来非常酷
[cli-table](https://github.com/Automattic/cli-table) 命令行表格工具,在命令行中输出表格
[Inquirer](https://github.com/SBoudrias/Inquirer.js) 交互式命令行工具,支持checkbox,list,问答式等等
[node-progress](https://github.com/visionmedia/node-progress) 命令操作进度显示

# **配置文件**
[cosmiconfig](https://github.com/davidtheclark/cosmiconfig) 读取配置文件,加载配置文件
